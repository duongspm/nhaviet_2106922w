    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <?php if (isset($config['setting']['opentime']) && $config['setting']['opentime'] == true) { ?>
                <div class="form-group col-md-4 col-sm-6">
                    <label for="opentime">Giờ mở cửa:</label>
                    <input type="text" class="form-control text-sm" name="data[options][opentime]" id="opentime"
                        placeholder="Giờ mở cửa"
                        value="<?= (!empty($flash->has('opentime'))) ? $flash->get('opentime') : @$options['opentime'] ?>"
                        required>
                </div>
                <?php } ?>
